...
const messages = {
  ...
  'settings.authentication': ['Authentication', '인증'],
  'settings.authenticationNone': ['None', '없음'],
  'settings.authenticationApiKey': ['API Key (Bearer)', 'API 키 (Bearer)'],
  'settings.authenticationBasic': ['Basic Authentication', '기본 인증'],
  'settings.authenticationHint': [
    'Credentials are stored securely in VS Code Secret Storage.',
    '인증 정보는 VS Code Secret Storage에 안전하게 저장됩니다.',
  ],
  'settings.apiKey': ['API key', 'API 키'],
  'settings.username': ['Username', '사용자 이름'],
  'settings.password': ['Password', '비밀번호'],
  'settings.secretStored': ['Stored securely — enter to replace', '안전하게 저장됨 — 변경 시 입력'],
